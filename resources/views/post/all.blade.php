    ...
    <div class="row">
        ...
        @foreach($posts as $posts)        
            ...
            <div class="col-md-5" style="border:15px solid #444444; border-radius: 4px">
                    <img width="100%" height ="250"  src="/images/userposts/{{$user->username}}/{{$posts->title}}/{{$posts->frontview}}" alt="">
            </div>
            @endif
            @endforeach
            <div class="col-md-4 detail-color">
                ...
                @if($posts->statuses_id == 2)
                  <label class="external-event montserratstyle-button">sold</label>
                @endif
                </h3>
