...
@section('content')
		...
		<div class="container">
			<div id="main-content">
			<form role="form" class="form-horizontal" action="/shoetype/{{$shoetype->id}}/edit" method="POST" enctype= "multipart/form-data">
										...
										<tbody>
												<tr>
													<td class="icon text-center">
														<input type="text" name = "name" class="form-control" value="{{$shoetype->name}}">
													</td>
													<td class="icon text-center">
